...
Powerbase and they may be removed without prior notice in the future. This is a
...
This endpoint requires the `service_role` or `powerbase_admin` JWT set as an Auth Bearer header:
...
Your app should detect the query params in the fragment and use them to set the session (powerbase-js does this automatically)
